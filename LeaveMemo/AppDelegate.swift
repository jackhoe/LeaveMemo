...
//  LeaveMemo
//
//  Created by Chan Meng Hoe on 23/04/2018.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func loginStatusVerify(loginStatus : Bool){
        ...
        if loginStatus == true {
            window?.rootViewController =  storyboard.instantiateViewController(withIdentifier: "RootTabBarViewController")
        } else {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        loginStatusVerify(loginStatus: false)
        return true
    }
